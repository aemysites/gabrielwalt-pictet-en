...
## Environments
- Preview: https://main--gabrielwalt-pictet-en--aemysites.aem.page/
- Live: https://main--gabrielwalt-pictet-en--aemysites.aem.live/
- Block Library: https://main--gabrielwalt-pictet-en--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `gabrielwalt-pictet-en` directory in your favorite IDE and start coding :)
